	...
	while true; do
		...
		[Yy]* ) echo -ne "So...tell me something\n";
			...
			for i in ${!array[@]}; do
				...
				curl -u $userGeoserver:$passGeoserver -XPOST -H 'Content-type: text/xml' -d '<coverage><name>'${array[$i]}'</name><title>'${array[$i]}'</title><nativeCRS>GEOGCS["ETRS89",DATUM["European_Terrestrial_Reference_System_1989",SPHEROID["GRS 1980",6378137,298.257222101,AUTHORITY["EPSG","7019"]],AUTHORITY["EPSG","6258"]],PRIMEM["Greenwich",0,AUTHORITY["EPSG","8901"]],UNIT["degree",0.01745329251994328,AUTHORITY["EPSG","9122"]],AUTHORITY["EPSG","4258"]],UNIT["metre",1,AUTHORITY["EPSG","9001"]],PROJECTION["Transverse_Mercator"],PARAMETER["latitude_of_origin",0],PARAMETER["central_meridian",-3],PARAMETER["scale_factor",0.9996],PARAMETER["false_easting",500000],PARAMETER["false_northing",0],AUTHORITY["EPSG","3042"],AXIS["Easting",EAST],AXIS["Northing",NORTH]]</nativeCRS><srs>EPSG:3857</srs>'$latLonBoundingBox'<projectionPolicy>REPROJECT_NATIVE_TO_DECLARED</projectionPolicy><dimensions><coverageDimension><name>GRAY_INDEX</name><description>GridSampleDimension[-Infinity,Infinity]</description><range><min>-inf</min><max>inf</max></range><nullValues><double>255.0</double></nullValues><dimensionType><name>UNSIGNED_8BITS</name></dimensionType></coverageDimension></dimensions></coverage>' http://localhost:8080/geoserver/rest/workspaces/$workspaceGeoserver/coveragestores/${array[$i]}/coverages > /dev/null;
